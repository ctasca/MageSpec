 ...
 */
class DescribeSuiteHelperCommand extends Command
{
    ...
    {
        $this
            ->setName('describe:suitehelper')
            ->setDescription('Describe a Magento Suite Helper specification')
            ->addArgument('helper_alias', InputArgument::REQUIRED, 'Magento Suite Helper alias to be described');
    }
...
Please make sure it looks like the following:
  ...
  vendorname_suitename_modulename/helpername
