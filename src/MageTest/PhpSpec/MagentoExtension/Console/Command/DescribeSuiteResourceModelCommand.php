 ...
 */
class DescribeSuiteResourceModelCommand extends Command
{
    ...
    {
        $this
            ->setName('describe:suiteresource_model')
            ->setDescription('Describe a Magento Suite Resource Model specification')
            ->addArgument('resource_model_alias', InputArgument::REQUIRED, 'Magento Suite Resource Model alias to be described');
    }
...
Please make sure it looks like the following:
  ...
  vendorname_suitename_modulename/resourcemodelname
