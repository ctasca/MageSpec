 ...
 */
class SuiteModelLocator implements ResourceLocatorInterface, SuiteLocatorInterface
{
    ...
    private function createResourceFromSpecFile($path)
    {
        ...
        return new SuiteModelResource(explode(DIRECTORY_SEPARATOR, $relative), $this);
    }
