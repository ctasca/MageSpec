 ...
 */
class SuiteControllerResource implements ResourceInterface
{
    private $parts;
    private $pathParts;
    private $locator;

    public function __construct(array $parts, SuiteControllerLocator $locator)
    {
        $this->parts   = $parts;
        $this->pathParts = $parts;
        array_splice($this->pathParts, 3, 0, array('controllers'));
