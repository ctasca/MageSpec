...
use MageTest\PhpSpec\MagentoExtension\Locator\Magento\SuiteModelResource;
 ...
 */
class SuiteModelGenerator implements GeneratorInterface
{
    private $io;
    private $templates;
    private $filesystem;
    ...
    {
        return 'class' === $generation && $resource instanceof SuiteModelResource;
    }
