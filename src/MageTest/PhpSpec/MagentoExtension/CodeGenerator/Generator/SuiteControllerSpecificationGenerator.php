...
class SuiteControllerSpecificationGenerator implements GeneratorInterface
{
    private $io;
    private $templates;
    private $filesystem;
    ...
    public function generate(ResourceInterface $resource, array $data = array())
    {
        ...
        $this->io->writeln(sprintf(
            "<info>SuiteControllerSpecification for <value>%s</value> created in <value>'%s'</value>.</info>\n",
