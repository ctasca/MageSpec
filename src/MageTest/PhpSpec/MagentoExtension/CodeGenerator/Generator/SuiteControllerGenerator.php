...
use MageTest\PhpSpec\MagentoExtension\Locator\Magento\SuiteControllerResource;
 ...
 */
class SuiteControllerGenerator implements GeneratorInterface
{
    private $io;
    private $templates;
    private $filesystem;
    ...
    {
        return 'class' === $generation && $resource instanceof SuiteControllerResource;
    }
    ...
    public function generate(ResourceInterface $resource, array $data = array())
    {
        ...
        $this->io->writeln(sprintf(
            "<info>Magento Suite controller <value>%s</value> created in <value>'%s'</value>.</info>\n",
...
class %name% extends Mage_Core_Controller_Front_Action
{
